...
## Export Docker image
 ...
 docker save repexprep-tools:1.0.0 \
    | gzip \
    > containers/repexprep-tools_1.0.0.docker.tar.gz

## Build Singularity image

singularity build \
    containers/repexprep-tools_1.0.0.sif \
    "docker-archive://$(pwd)/containers/repexprep-tools_1.0.0.docker.tar.gz"
